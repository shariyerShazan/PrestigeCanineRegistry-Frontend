      ...
      <div className="relative container mx-auto px-6 py-20">
        <div className="max-w-2xl">
          ...
          <p className="text-xl font-extralight text-white/90 mb-4">
            Register your dog with verified DNA & microchip data and receive
            your permanent PCR ID - the world's first digital proof of canine
            authenticity.
          </p>

          {/* Tagline */}
          <p className="text-lg text-white font-light mb-8">
            Because Paperwork Can Lie - DNA Doesn't.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <Button
              ...
              size="lg"
              className="bg-[#D4AF37] cursor-pointer hover:bg-yellow-600 text-black font-semibold"
            >
        ...
        <div className="hidden lg:block absolute top-[30%] right-20">
          <div className="backdrop-blur-md border border-[#D4AF37] text-white  py-3 px-4 rounded-lg shadow-lg">
            ...
            <div className="text-xs text-[#D4AF37] opacity-90">
              Golden Retriever
            </div>
