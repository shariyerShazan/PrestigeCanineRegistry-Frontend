  ...
  return (
      ...
      <div className="bg-white p-6 rounded-xl border shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
           <div className="space-y-2">
            ...
            <Select >
              <SelectTrigger className="!h-8 border text-sm cursor-pointer text-start pl-3 border-slate-200 rounded-md w-full">
                <SelectValue placeholder="Select role" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="Gold">Admin</SelectItem>
                <SelectItem value="Blue">Owner</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select >
              ...
              <SelectContent>
                <SelectItem value="Gold">John doe</SelectItem>
                <SelectItem value="Gold">Shariyer</SelectItem>
                <SelectItem value="Blue">Shazan</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
            ...
            <Input type={showNewPassword ? 'text' : 'password'} placeholder="Enter Old Password" />
            <button
              type="button"
      ...
      <div className="bg-white p-6 rounded-xl border shadow-sm">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between border p-3 rounded-md border-gray-300">
            <div className="space-y-0.5">
              <Label className="text-base">Certificate Requests</Label>
              <p className="text-sm text-muted-foreground">Get notified when new dogs are registered</p>
            </div>
            <Switch className="data-[state=checked]:bg-[#D4AF37]" />
          </div>
